<div wire:key={{ $todo->id }}
    ...
    <div class="mt-3 text-xs text-gray-700">
        ...
        @if ($editId == $todo->id)
            <button wire:click='update({{$todo}})' class="mt-3 px-4 py-2 bg-teal-500 text-white font-semibold rounded hover:bg-teal-600">
                Update
            </button>
            <button wire:click='editCancle({{$todo}})' class="mt-3 px-4 py-2 bg-red-500 text-white font-semibold rounded hover:bg-red-600">
                Cancel
            </button>
        @endif
